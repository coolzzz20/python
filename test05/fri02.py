...
while True:
    ...
    choice = int(input('원하는 좌석 번호 입력(종료: -1)>>> ')) - 1
    if choice == -2:
...
#     print(x)
print('예매한 자리는', end=' ')
for x in range(0, len(seat)): #좌석은 index값을 이용해서 리스트에 있는 값을 출력한다.
	if seat[x] == 1:
	    print(str(x+1), '좌석', end=' ')
print('입니다')
